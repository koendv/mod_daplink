...
__STATIC_INLINE void PORT_JTAG_SETUP(void)
{
  ...
  gpio_set_dir(PIN_nRESET, GPIO_IN);
...
{
  return gpio_get(PIN_TDO);   // Not available
}
...
__STATIC_INLINE void DAP_SETUP(void)
{
  gpio_init(PIN_SWDIO);
  gpio_init(PIN_SWCLK);
  gpio_init(PIN_nRESET);
  gpio_init(PIN_TDI);
  gpio_init(PIN_TDO);
  gpio_init(PIN_LED);

  gpio_set_slew_rate(PIN_SWDIO, GPIO_SLEW_RATE_FAST);
  gpio_set_slew_rate(PIN_SWCLK, GPIO_SLEW_RATE_FAST);

  gpio_pull_up(PIN_nRESET);
